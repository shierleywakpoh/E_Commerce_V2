...
function SellerLogin() {
  ...
  const onSubmitHandler = async (event) => {
    try {
      ...
      const { data } = await axios.post("/adminRegister/Login", {
        email,
        password,
      });
  ...
  return (
    !isSeller && (
      ...
      >
        <div className="flex flex-col gap-5 m-auto items-start p-8 py-12 min-w-80  rounded-lg shadow-xl border border-gray-200">
